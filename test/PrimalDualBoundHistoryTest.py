...
class PrimalDualBoundHistoryTest(unittest.TestCase):
    ...
    def testEmptyLine(self):
        ...
        """
        correctPbHistory = [ (0.1, 0.117640800073596), (0.1, 0.1176408), (0.1, 0.2329977), (0.2, 0.2333972), (0.2, 0.2425407), (0.2, 0.2458207), (42.6, 0.2529466), (42.7, 0.2533669), (42.9, 0.2566015), (43.0, 0.2580527)]
        ex = Experiment()
